...
+
. Select the *RHEL* and click *Guest Operating System Type* as *rhel.10* and click *Next* 
+
...
+
. On the Compute resources verify that *General Purpose* is selected and Click *Next Twitce*
